    ...
    table, th, td {
     ...
     table#inv-tab th,table#inv-tab2 th{
      ...
      <table id="inv-tab" cellpadding="4">
        <thead>
          <tr>
            <th style="font-size:9px;"><b>Faktutanummer</b></th>
            <th style="font-size:9px;"><b>Beskrivelse</b></th>
            <th style="font-size:9px;"><b>Fakturadato</b></th>
            <th style="font-size:9px;"><b>Forfallsdato</b></th>
      ...
      <div>
        <p style="font-size:8px"><b style="font-size:9px;">Betalingsbetingelser</b><br />
            ...
            <td colspan="2">
             <table>
              <tbody>
               ...
               <tr>
                <td style="text-indent:15px;"><b>Purring</b></td>
                <td></td>
               </tr>
