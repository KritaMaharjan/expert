...
<form action="" method="POST" name="reset">
 ...
 <div class="form-group   @if($errors->has('email')) {{'has-error'}} @endif">
                ...
                @if($errors->has('email'))
                    {!! $errors->first('email', '<label for="inputError" class="control-label error has-error"><i class="fa fa-times-circle-o"></i> :message</label>') !!}
                @endif
            </div>
            <div class="form-group  has-feedback @if($errors->has('password')) {{'has-error'}} @endif ">
                ...
                @if($errors->has('new_password'))
                    {!! $errors->first('new_password', '<label for="inputError" class="control-label error has-error"><i class="fa fa-times-circle-o"></i> :message</label>') !!}
                @endif
            </div>
            <div class="form-group  has-feedback @if($errors->has('new_password_confirmation')) {{'has-error'}} @endif">
                ...
                @if($errors->has('new_password_confirmation'))
                    {!! $errors->first('new_password_confirmation', '<label for="inputError" class="control-label error has-error"><i class="fa fa-times-circle-o"></i> :message</label>') !!}
                @endif
            </div>
