		<form method="post" name="support_email_setting" class="form-horizontal">
					...
					<div class="form-group no-mg">
						...
						<input class="form-control" name="port" value="<?php echo isset($support_smtp['port'])?$support_smtp['port']:'25';?>" >  
					...
					<div class="form-group no-mg">
						...
						<input class="form-control" name="email" value="<?php echo isset($support_smtp['email'])?$support_smtp['email']:'';?>" >  
