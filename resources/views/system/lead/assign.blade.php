                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <ul class="list-unstyled">
                                <li><strong>{{ $lead->given_name .' '. $lead->surname }}</strong></li>
                                <li><strong>Preferred Name:</strong> {{ $lead->preferred_name }}</li>
                                <li><strong>Current Phone Number:</strong> {{ $lead->current_phone }}</li>
                                <li><strong>Loan Type:</strong> {{ $lead->loan_type }}</li>
                                <li><strong>Loan Purpose:</strong> {{ $lead->loan_purpose }}</li>
                                <li><strong>Referral Notes:</strong> {{ $lead->referral_notes }}</li>
                            </ul>
                        </div>
                    </div>
                </div>
