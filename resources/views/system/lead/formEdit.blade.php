                ...
                <div class='row'>
                    <div class='col-md-6'>
                        <div class="form-group">
                            ...
                            {!!Form::select('loan_type', config('general.loan_type'), Input::old('loan_type') ? Input::old('loan_type') : $lead->loan->loan_type, array('class' =>
                            'form-control'))!!}
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group @if($errors->has('property_search_area')) {{'has-error'}} @endif">
                            ...
                            {!!Form::text('property_search_area', null, array('class' => 'form-control'))!!}
                ...
                <div class='row'>
                    <div class='col-md-6'>
                        <div class="form-group">
                            ...
                            {!!Form::select('loan_purpose', config('general.loan_purpose'), Input::old('loan_purpose') ? Input::old('loan_purpose') : $lead->loan->loan_purpose, array('class' =>
                            'form-control'))!!}
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group @if($errors->has('bank_name')) {{'has-error'}} @endif">
                            {!!Form::label('Bank') !!}
                            {!!Form::text('bank_name', Input::old('bank_name') ? Input::old('bank_name') : $lead->loan->bank_name, array('class' => 'form-control'))!!}
                ...
                <div class='row'>
                    <div class="col-md-6">
                        <div class="form-group @if($errors->has('area')) {{'has-error'}} @endif">
                            {!!Form::label('Area') !!}
                            {!!Form::text('area', Input::old('area') ? Input::old('area') : $lead->loan->area, array('class' => 'form-control'))!!}
                            @if($errors->has('area'))
                ...
                <div class='row'>
                    <div class='col-md-6'>
                        <div class="form-group @if($errors->has('interest_rate')) {{'has-error'}} @endif">
                            ...
                            {!!Form::text('interest_rate', Input::old('interest_rate') ? Input::old('interest_rate') : $lead->loan->interest_rate, array('class' => 'form-control'))!!}
                    ...
                    <div class="col-md-6">
                        <div class="form-group clearfix {{ ($errors->has('interest_date_till'))? 'has-error': '' }}">
                            ...
                            <div id="due_date" class="input-group date">
                                {!! Form:: text('interest_date_till', Input::old('interest_date_till') ? Input::old('interest_date_till') : $lead->loan->interest_date_till, array('class' => 'form-control date-picker')) !!}
                ...
                <div class='row'>
                    <div class="col-md-6">
                        <div class="form-group @if($errors->has('amount')) {{'has-error'}} @endif">
                            {!!Form::label('Amount') !!}
                            {!!Form::text('amount', Input::old('amount') ? Input::old('amount') : $lead->loan->amount, array('class' => 'form-control'))!!}
