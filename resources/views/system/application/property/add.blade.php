<div class="new-property">
    <div class="box no-border">
        <div class="box-header with-border">
            <h3 class="box-title">Property <span class="property-num">{{$total_properties + 1}}</span> Details</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
    ...
    <div class="box box-primary">
        ...
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class='col-md-6'>
                    <label><input type="radio" class="rental_income" name="rental_income[]" value=1 checked="checked" /> Yes</label>
                    <label><input type="radio" class="rental_income[]" name="rental_income[]" value=0 /> No</label>
                </div>
            </div>
    ...
    <div class="box box-primary">
        ...
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class='col-md-6'>
                    <label><input type="radio" class="existing_loans" name="existing_loans[]" value=1 /> Yes</label>
                    <label><input type="radio" class="existing_loans" name="existing_loans[]" value=0 checked="checked" /> No</label>
                </div>
            </div>
                ...
                <div class="form-group clearfix {{ ($errors->has('fixed_rate_expiry_date'))? 'has-error': '' }}">
                    ...
                    <div class='col-md-6'>
                        <div id="due_date" class="input-group date">
                            <input type="text" name="fixed_rate_expiry_date[]" class="form-control expiry_date" />
