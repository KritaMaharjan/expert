@foreach($properties as $prop_key => $property)
    <div class="new-property">
        <div class="box no-border">
            ...
            <!-- /.box-header -->
            <div class="box-body">
                <input type="hidden" name="property_id[{{$prop_key}}]" value="{{$property->property_id}}"/>
                ...
                <div class="form-group">
                    ...
                    <div class='col-md-6'>
                        <label><input type="radio" name="taken_as_security[{{$prop_key}}]"
                                      value=1 {{($property->taken_as_security == 1) ? 'checked="checked"' : ''}} /> Yes</label>
                        <label><input type="radio" name="taken_as_security[{{$prop_key}}]"
                                      value=0 {{($property->taken_as_security == 0) ? 'checked="checked"' : ''}} />
                            No</label>
                    </div>
                </div>
                ...
                <div class="form-group @if($errors->has('market_value')) {{'has-error'}} @endif">
                    ...
                    <div class='col-md-6'>
                        <input type="text" name="market_value[{{$prop_key}}]" value="{{$property->market_value}}"
                               class="form-control"/>
                ...
                <div class="form-group @if($errors->has('title_particulars')) {{'has-error'}} @endif">
                    ...
                    <div class='col-md-6'>
                        <input type="text" name="title_particulars[{{$prop_key}}]"
                               value="{{$property->title_particulars}}" class="form-control"/>
                ...
                <div class="form-group @if($errors->has('title_type')) {{'has-error'}} @endif">
                    ...
                    <div class='col-md-6'>
                        <input type="text" name="title_type[{{$prop_key}}]" value="{{$property->title_type}}"
                               class="form-control"/>
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div class="form-group @if($errors->has('line1')) {{'has-error'}} @endif">
                    ...
                    <div class='col-md-6'>
                        <input type="text" name="line1[{{$prop_key}}]" value="{{$property->line1}}"
                               class="form-control"/>
                        @if($errors->has('line1'))
                ...
                <div class="form-group @if($errors->has('line2')) {{'has-error'}} @endif">
                    ...
                    <div class='col-md-6'>
                        <input type="text" name="line2[{{$prop_key}}]" value="{{$property->line2}}"
                               class="form-control"/>
                        @if($errors->has('line2'))
                ...
                <div class="form-group @if($errors->has('suburb')) {{'has-error'}} @endif">
                    ...
                    <div class='col-md-6'>
                        <input type="text" name="suburb[{{$prop_key}}]" value="{{$property->suburb}}"
                               class="form-control"/>
                ...
                <div class="form-group @if($errors->has('postcode')) {{'has-error'}} @endif">
                    ...
                    <div class='col-md-6'>
                        <input type="text" name="postcode[{{$prop_key}}]" value="{{$property->postcode}}"
                               class="form-control"/>
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class='col-md-6'>
                        <label><input type="radio" class="rental_income" name="rental_income[{{$prop_key}}]"
                                      value=1 {{!empty($property->income)? 'checked="checked"' : ''}} /> Yes</label>
                        <label><input type="radio" class="rental_income" name="rental_income[{{$prop_key}}]"
                                      value=0 {{empty($property->income)? 'checked="checked"' : ''}} /> No</label>
                    </div>
                </div>
                ...
                <div class="rental-details">
                    ...
                    <div class="form-group @if($errors->has('weekly_rental')) {{'has-error'}} @endif">
                        ...
                        <div class='col-md-6'>
                            <input type="text" name="weekly_rental[{{$prop_key}}]"
                                   value="{{$property->income->weekly_rental or ''}}" class="form-control"/>
                    ...
                    <div class="form-group @if($errors->has('credit_to')) {{'has-error'}} @endif">
                        ...
                        <div class='col-md-6'>
                            <input type="text" name="credit_to[{{$prop_key}}]"
                                   value="{{$property->income->credit_to or ''}}" class="form-control"/>
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div class="form-group @if($errors->has('contact_person')) {{'has-error'}} @endif">
                    ...
                    <div class='col-md-6'>
                        <input type="text" name="contact_person[{{$prop_key}}]"
                               value="{{$property->contact_person or ''}}" class="form-control"/>
                    </div>
                </div>
                ...
                <div class="form-group @if($errors->has('phone_number')) {{'has-error'}} @endif">
                    ...
                    <div class='col-md-6'>
                        <input type="text" name="phone_number[{{$prop_key}}]" value="{{$property->phone_number}}"
                               class="form-control"/>
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class='col-md-6'>
                        <label><input type="radio" class="existing_loans" name="existing_loans[{{$prop_key}}]"
                                      value=1 {{!empty($property->existing_loans)? 'checked="checked"' : ''}} />
                            Yes</label>
                        <label><input type="radio" class="existing_loans" name="existing_loans[{{$prop_key}}]"
                                      value=0 {{empty($property->existing_loans)? 'checked="checked"' : ''}} />
                            No</label>
                    </div>
                </div>

                <div class="loans-details" style="{{!empty($property->existing_loans)? '': 'display:none'}}">
                    ...
                    <div class="form-group">
                        ...
                        <div class='col-md-6'>
                            <label><input type="radio" name="to_be_cleared[{{$prop_key}}]" value=1 checked="checked"/>
                                Yes</label>
                    ...
                    <div class="form-group @if($errors->has('lender')) {{'has-error'}} @endif">
                        ...
                        <div class='col-md-6'>
                            <input type="text" name="lender[{{$prop_key}}]"
                                   value="{{$property->existing_loans->lender or ''}}" class="form-control"/>
                    ...
                    <div class="form-group @if($errors->has('fixed_rate_term')) {{'has-error'}} @endif">
                        ...
                        <div class='col-md-6'>
                            <input type="text" name="fixed_rate_term[{{$prop_key}}]"
                                   value="{{$property->existing_loans->fixed_rate_term or ''}}" class="form-control"/>
                    ...
                    <div class="form-group clearfix {{ ($errors->has('fixed_rate_expiry_date'))? 'has-error': '' }}">
                        ...
                        <div class='col-md-6'>
                            <div id="due_date" class="input-group date">
                                {!! Form:: text('fixed_rate_expiry_date['.$prop_key.']', $property->existing_loans->fixed_rate_term or '', array('class' => 'form-control
                                expiry_date')) !!}
                    ...
                    <div class="form-group @if($errors->has('limit')) {{'has-error'}} @endif">
                        ...
                        <div class='col-md-6'>
                            <input type="text" name="limit[{{$prop_key}}]"
                                   value="{{$property->existing_loans->limit or ''}}" class="form-control"/>
                            @if($errors->has('limit'))
                    ...
                    <div class="form-group @if($errors->has('balance')) {{'has-error'}} @endif">
                        ...
                        <div class='col-md-6'>
                            <input type="text" name="balance[{{$prop_key}}]"
                                   value="{{$property->existing_loans->balance or ''}}" class="form-control"/>
