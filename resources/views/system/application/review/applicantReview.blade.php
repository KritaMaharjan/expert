<h3>Applicant Details
    <a class="pull-right" href="{{route('system.application.add', [$lead_id])}}"><i class="fa fa-pencil"></i></a>
</h3>
<hr/>
...
@foreach($applicant_details as $key => $applicant_detail)
    <div class="box box-linked collapsed-box">
        <div class="box-header with-border">
            <h3 class="box-title">Applicant {{$key + 1}}</h3>
            ...
            <div class="">
                ...
                <table class="table table-striped table-hover">
                    ...
                    @foreach($applicant_detail->address as $address)
                        <tr>
                            <td colspan="2"
                                class="col-md-10 title-sm">{{($address->iscurrent == 0 && $address->type == 'Home')? 'Previous': $address->type}}
                                Address
                            </td>
                        </tr>
                        <tr>
