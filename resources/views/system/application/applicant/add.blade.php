<div class="new-applicant">
    <div class="box no-border">
        ...
        <div class="box-body">
            ...
            <div class="form-group remove-block">
                <div class='col-md-3 control-label'>{!!Form::label('Added this by mistake?') !!}</div>
                <div class='col-md-9'>
    ...
    <div class="box no-border">
        ...
        <div class="box-body">
            <div class="form-group @if($errors->has('mobile')) {{'has-error'}} @endif">
                <div class='col-md-3 control-label'>{!!Form::label('Mobile Number') !!}</div>
                <div class='col-md-9'>
            ...
            <div class="form-group @if($errors->has('home')) {{'has-error'}} @endif">
                <div class='col-md-3 control-label'>{!!Form::label('Home Phone Number') !!}</div>
                <div class='col-md-9'>
            ...
            <div class="form-group @if($errors->has('work')) {{'has-error'}} @endif">
                <div class='col-md-3 control-label'>{!!Form::label('Work Phone Number') !!}</div>
                <div class='col-md-9'>
            ...
            <div class="form-group @if($errors->has('fax')) {{'has-error'}} @endif">
                <div class='col-md-3 control-label'>{!!Form::label('Fax Number') !!}</div>
                <div class='col-md-9'>
            ...
            <div class="form-group">
                <div class='col-md-3 control-label'>{!!Form::label('Additional Phone') !!}
                    <a class="add-phone pull-right"><i class="fa fa-plus-circle"></i></a>
                </div>

                <div class="phone-group col-md-9">
    ...
    <div class="box no-border">
        ...
        <div class="box-body">
            ...
            <div class="form-group @if($errors->has('home_line1')) {{'has-error'}} @endif">
                <div class='col-md-3 control-label'>{!!Form::label('Line 1') !!}</div>
                <div class='col-md-9'>
            ...
            <div class="form-group @if($errors->has('home_line2')) {{'has-error'}} @endif">
                <div class='col-md-3 control-label'>{!!Form::label('Line 2') !!}</div>
                <div class='col-md-9'>
            ...
            <div class="form-group @if($errors->has('home_suburb')) {{'has-error'}} @endif">
                <div class='col-md-3 control-label'>{!!Form::label('Suburb') !!}</div>
                <div class='col-md-9'>
            ...
            <div class="form-group">
                <div class='col-md-3 control-label'>{!!Form::label('State') !!}</div>
                <div class='col-md-9'>
            ...
            <div class="form-group @if($errors->has('home_postcode')) {{'has-error'}} @endif">
                <div class='col-md-3 control-label'>{!!Form::label('Postcode') !!}</div>
                <div class='col-md-9'>
            ...
            <div class="form-group">
                <div class='col-md-3 control-label'>{!!Form::label('Country') !!}</div>
                <div class='col-md-9'>
            ...
            <div class="form-group @if($errors->has('weekly_rent_expense')) {{'has-error'}} @endif">
                <div class='col-md-3 control-label'>{!!Form::label('Weekly Rent Expense') !!}</div>
                <div class='col-md-9'>
            ...
            <div class="form-group">
                <div class='col-md-3 control-label'>{!!Form::label('To be cleared') !!}</div>
                <div class='col-md-9'>
            ...
            <div class="form-group @if($errors->has('debit_from')) {{'has-error'}} @endif">
                <div class='col-md-3 control-label'>{!!Form::label('Debit From') !!}</div>
                <div class='col-md-9'>
            ...
            <div class="form-group clearfix {{ ($errors->has('live_there_since'))? 'has-error': '' }}">
                <div class='col-md-3 control-label'>{!! Form::label('Living there since') !!}</div>
                <div class='col-md-9'>
                    <div id="due_date" class="input-group date">
    ...
    <div class="box no-border">
        ...
        <div class="box-body">
            <div class="form-group">
                <div class='col-md-3 control-label'>{!!Form::label('Employment Type') !!}</div>
                <div class='col-md-9'>
            ...
            <div class="form-group @if($errors->has('job_title')) {{'has-error'}} @endif">
                <div class='col-md-3 control-label'>{!!Form::label('Job Title') !!}</div>
                <div class='col-md-9'>
            ...
            <div class="form-group clearfix {{ ($errors->has('starting_date'))? 'has-error': '' }}">
                <div class='col-md-3 control-label'>{!! Form::label('Starting Date') !!}</div>
                <div class='col-md-9'>
                    <div id="due_date" class="input-group date">
            ...
            <div class="form-group @if($errors->has('business_name')) {{'has-error'}} @endif">
                <div class='col-md-3 control-label'>{!!Form::label('Employer Business Name') !!}</div>
                <div class='col-md-9'>
            ...
            <div class="form-group @if($errors->has('abn')) {{'has-error'}} @endif">
                <div class='col-md-3 control-label'>{!!Form::label('Employer ABN') !!}</div>
                <div class='col-md-9'>
            ...
            <div class="form-group @if($errors->has('contact_person')) {{'has-error'}} @endif">
                <div class='col-md-3 control-label'>{!!Form::label('Contact Person') !!}</div>
                <div class='col-md-9'>
            ...
            <div class="form-group @if($errors->has('contact_person_job_title')) {{'has-error'}} @endif">
                <div class='col-md-3 control-label'>{!!Form::label('Contact Person Job Title') !!}</div>
                <div class='col-md-9'>
            ...
            <div class="form-group @if($errors->has('contact_number')) {{'has-error'}} @endif">
                <div class='col-md-3 control-label'>{!!Form::label('Contact Number') !!}</div>
                <div class='col-md-9'>
