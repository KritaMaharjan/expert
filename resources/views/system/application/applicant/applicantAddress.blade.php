    ...
    <div class="box no-border">
        ...
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class='col-md-6'>
                    <select name="{{$name_pref}}-state[{{$app_key}}]" class="form-control">
            ...
            <div class="form-group @if($errors->has('home_postcode')) {{'has-error'}} @endif">
                ...
                <div class='col-md-6'>
                    <input type="text" value="{{$address->postcode}}" class="form-control"
                           name="{{$name_pref}}-postcode[{{$app_key}}]"/>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class='col-md-6'>
                    <select name="{{$name_pref}}-country[{{$app_key}}]" class="form-control">
