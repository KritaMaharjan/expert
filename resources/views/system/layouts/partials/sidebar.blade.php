            ...
            <li>
             ...
             <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{{route('system.setting.email')}}" title="Emails"><i class="fa fa-circle-o"></i> Emails</a></li>
                <li><a href="{{route('system.setting.template')}}" title="Templates"><i class="fa fa-circle-o"></i> Templates</a></li>
              </ul>
            </li>
          </ul>
        </section>
