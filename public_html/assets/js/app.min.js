...
$(function () {
    $(document).on('shown.bs.modal', '#fb-modal', function (event) {
    ...
    $(document).on('hidden.bs.modal', '#fb-modal', function (event) {
        var modal = $(this)
    ...
    $(document).on('show.bs.modal', '#fb-modal', function (event) {
