...
$.AdminLTE = new Object, $.AdminLTE.options = {
    ...
    $.AdminLTE.layout.activate(), $.AdminLTE.tree(".sidebar"), a.navbarMenuSlimscroll && "undefined" != typeof $.fn.slimscroll && $(".navbar .menu").slimscroll({
        ...
        alwaysVisible: !1,
        size: "3px"
    }).css("width", "100%"), a.sidebarPushMenu && $.AdminLTE.pushMenu(a.sidebarToggleSelector), a.enableBSToppltip && $(a.BSTooltipSelector).tooltip(), a.enableBoxWidget && $.AdminLTE.boxWidget.activate(), a.enableFastclick && "undefined" != typeof FastClick && FastClick.attach(document.body), $('.btn-group[data-toggle="btn-toggle"]').each(function () {
        var a = $(this);
    ...
    $(a).click(function (a) {
        a.preventDefault(), $("body").toggleClass("sidebar-collapse"), $("body").toggleClass("sidebar-open")
    ...
    $("li a", $(a)).click(function (a) {
        var b = $(this),
            c = b.next();
        if (c.is(".treeview-menu") && c.is(":visible")) c.slideUp("normal", function () {
            c.removeClass("menu-open")
        }), c.parent("li").removeClass("active");
        else if (c.is(".treeview-menu") && !c.is(":visible")) {
            var d = b.parents("ul").first(),
                e = d.find("ul:visible").slideUp("normal");
            e.removeClass("menu-open");
            var f = b.parent("li");
            c.slideDown("normal", function () {
                c.addClass("menu-open"), d.find("li.active").removeClass("active"), f.addClass("active")
            })
        }
        c.is(".treeview-menu") && a.preventDefault()
    })
}, $.AdminLTE.boxWidget = {
    activate: function () {
        var a = $.AdminLTE.options,
    ...
    function (a) {
        a.fn.boxRefresh = function (b) {
            ...
            var e = a.extend({
                ...
                f = a('<div class="overlay"></div><div class="loading-img"></div>');
...
$(function () {
    $(document).on('shown.bs.modal', '#ex-modal', function (event) {
    ...
    $(document).on('hidden.bs.modal', '#ex-modal', function (event) {
        var modal = $(this)
    ...
    $(document).on('show.bs.modal', '#ex-modal', function (event) {
    ...
    $("[data-widget='collapse']").click(function() {
        ...
        if (!$(this).children().hasClass("fa-plus")) {
            //thisClicked.parents(".box-linked").not(box).each(function(){
            $(".box-linked").not(box).each(function(){
                var thisbf = $(this).find(".box-body, .box-footer");
