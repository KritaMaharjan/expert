    ...
    function add(array $request, $lead_id)
    {
        ...
        try {
            ...
            $applicant = Applicant::create([
                ...
                'years_in_au' => $request['years_in_au'],
                'marital_status' => $request['marital_status'],
                'email' => $request['email'],
                'mother_maiden_name' => $request['mother_maiden_name'],
                'credit_card_issue' => $request['credit_card_issue'],
            ...
            $home_address = Addresses::create([
                'line1' => $request['home_line1'],
                'line2' => $request['home_line2'],
                'suburb' => $request['home_suburb'],
                'state' => $request['home_state'],
                'postcode' => $request['home_postcode'],
            ...
            ApplicantAddress::create([
                ...
                'live_there_since' => $request['live_there_since']
            ]);

            RentExpense::create([
                'weekly_rent_expense' => $request['weekly_rent_expense'],
                'applicant_id' => $applicant->id,
                'debit_from' => $request['debit_from']
            ]);

            $postal_address = Addresses::create([
                'line1' => $request['postal_line1'],
                'line2' => $request['postal_line2'],
            ...
            $previous_address = Addresses::create([
                'line1' => $request['previous_line1'],
                'line2' => $request['previous_line2'],
                'suburb' => $request['previous_suburb'],
                'state' => $request['previous_state'],
                'postcode' => $request['previous_postcode'],
                'country' => $request['previous_country']
            ]);
            ...
            $employment_address = Addresses::create([
                'line1' => $request['employment_line1'],
                'line2' => $request['employment_line2'],
                'suburb' => $request['employment_suburb'],
                'state' => $request['employment_state'],
                'postcode' => $request['employment_postcode'],
                'country' => $request['employment_country']
            ]);
